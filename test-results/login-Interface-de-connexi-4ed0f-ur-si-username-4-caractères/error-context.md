...
- Name: Interface de connexion - MyApp >> TC-L3 - Affiche une erreur si username < 4 caractères
- Location: /home/leniorju/Documents/school/INFO_L3/INF352/TP final/TP_INF352_G3_Testing/tests/login.spec.js:17:3
...
Call log:
  ...
  - attempting click action
    ...
    at /home/leniorju/Documents/school/INFO_L3/INF352/TP final/TP_INF352_G3_Testing/tests/login.spec.js:21:16
```
...
- text: 
- textbox "Nom d'utilisateur": ab
- text: Nom d'utilisateur Le nom d'utilisateur doit contenir au moins 4 caractères 
- textbox "Mot de passe": Valid123!
- text: Mot de passe  8 caractères minimum  1 majuscule  1 chiffre  1 caractère spécial
